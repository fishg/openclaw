...
function resolvePluginToolLoadState(params: {
  ...
  return { context, env, loadOptions, onlyPluginIds, pluginIdPhaseMs, runtimeOptions, snapshot };
}
...
export function resolvePluginTools(params: {
  ...
  const { context, env, onlyPluginIds, pluginIdPhaseMs, runtimeOptions, snapshot } = loadState;
  const tools: AnyAgentTool[] = [];
